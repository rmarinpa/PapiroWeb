    ...
    <div class="container">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <asp:Button ID="btnBuscarRut" runat="server" CssClass="btn btn-outline-danger" Text="Buscar por rut" OnClick="btnBuscarRut_Click" />
            </div>
        ...
        <asp:Button ID="btnModificar" CssClass="btn btn-secondary" runat="server" Text="Modificar" />
        <asp:Button ID="btnEliminar" CssClass="btn btn-secondary" runat="server" Text="Eliminar" />
        <asp:Button ID="btnLimpiar" CssClass="btn btn-secondary" runat="server" Text="Limpiar" />
    </div>
